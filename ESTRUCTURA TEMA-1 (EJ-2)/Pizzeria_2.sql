...
CREATE TABLE IF NOT EXISTS `mydb`.`Comanda` (
  ...
  INDEX `fk_Comanda_Producte1_idx` (`id_Producte` ASC, `Producte_Descripcion` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Comanda_Producte1`
    FOREIGN KEY (`id_Producte` , `Producte_Descripcion`)
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Comanda` (`Id_comanda`, `Fecha_pedido`, `tipo_venta`, `Cantidad_productos`, `Precio`, `Tipo_Productos`, `iId_cliente`, `Id_botiga`, `id_Producte`, `Producte_Descripcion`) VALUES (1, '2022-06-12', 'reparto', 3, 30, 'pizza', DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `mydb`.`Comanda` (`Id_comanda`, `Fecha_pedido`, `tipo_venta`, `Cantidad_productos`, `Precio`, `Tipo_Productos`, `iId_cliente`, `Id_botiga`, `id_Producte`, `Producte_Descripcion`) VALUES (2, '2021-08-05', 'recoger', 4, 25, 'hamburguesa', DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `mydb`.`Comanda` (`Id_comanda`, `Fecha_pedido`, `tipo_venta`, `Cantidad_productos`, `Precio`, `Tipo_Productos`, `iId_cliente`, `Id_botiga`, `id_Producte`, `Producte_Descripcion`) VALUES (3, '2020-11-23', 'recoger', 1, 20, 'beguda', DEFAULT, DEFAULT, DEFAULT, DEFAULT);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Empleat` (`Id_empleat`, `Nombre`, `Apellido_1`, `Apellido_2`, `Nif`, `Telefon`, `Tipus`, `Id_botiga`, `id_entrega`) VALUES (1, 'Luis', 'Garcia', 'Perez', 12312312A, 9301010101010, 'cuiner', DEFAULT, DEFAULT);
INSERT INTO `mydb`.`Empleat` (`Id_empleat`, `Nombre`, `Apellido_1`, `Apellido_2`, `Nif`, `Telefon`, `Tipus`, `Id_botiga`, `id_entrega`) VALUES (2, 'Pedro', 'Marquez', 'Lopez', 52453456B, 9312312343, 'repartidor', DEFAULT, DEFAULT);
INSERT INTO `mydb`.`Empleat` (`Id_empleat`, `Nombre`, `Apellido_1`, `Apellido_2`, `Nif`, `Telefon`, `Tipus`, `Id_botiga`, `id_entrega`) VALUES (3, 'Maria', 'Galindo', 'Fernandez', 12312312E, 9312312333, 'cuiner', DEFAULT, DEFAULT);
